...
<img src="/Result1.PNG" width="500"><img src="/Result2.PNG" width="500"><img src="/Result3.PNG" width="800">
...
### Hunting Mode（ハンティングモード）
- チームなしプレイヤー：アーチャー（馬に騎乗）として狩りを行う
- チームありプレイヤー：オオカミとして制限時間まで生き残ることを目指す
- アーチャーは個人スコアを稼ぐ
- オオカミの生存数がチームの合計生存スコアとなる
- NPCはスポーンしない（プレイヤーのみ）
- 矢は無制限、時間制限は必須
