...
namespace AdvancedSceneManager.Utility
{
    ...
    /// <summary>Represents a in-scene cache for game objects. Enables fast lookup, instead of scanning heirarchy.</summary>
    [AddComponentMenu("")]
    public class SceneObjectReferenceCache : MonoBehaviour
    {

        internal SerializableDictionary<string, Object> references = new();

        /// <summary>Enumerates all cached references.</summary>
        ...
        /// <summary>Gets a cached reference.</summary>
        ...
        /// <summary>Set the object to cache.</summary>
        ...
        /// <summary>Removes a cached reference.</summary>
