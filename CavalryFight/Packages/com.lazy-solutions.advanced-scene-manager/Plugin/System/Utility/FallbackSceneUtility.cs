...
namespace AdvancedSceneManager.Utility
{
    ...
    public static class FallbackSceneUtility
    {
        ...
        /// <summary>Gets the name of the fallback scene.</summary>
        public const string Name = "ASM - Fallback scene";

        /// <summary>Gets if the fallback scene is active in the heirarchy.</summary>
        ...
        internal static Awaitable EnsureOpenAsync()
        {
#if UNITY_EDITOR
            var fallbackScene = GetScene();
            if (!fallbackScene.isLoaded)
                return LoadAsync(GetPath());
#endif
            return default;
        }
        ...
        static async Awaitable LoadAsync(string path)
        {
#if UNITY_EDITOR
        ...
        internal static string GetStartupScene() =>
            SceneManager.profile && SceneManager.profile.startupScene
            ? SceneManager.profile.startupScene.path
            : SceneManager.assets.fallbackScenePath;
