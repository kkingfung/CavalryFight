...
namespace AdvancedSceneManager.Utility
{
    ...
    internal static class LinqUtility
    {
        ...
        public static IEnumerable<T> NonNull<T>(this IEnumerable<T> list) =>
            list.Where(o => o is UnityEngine.Object obj ? obj : o is not null);

        public static IEnumerable<T> NonHidden<T>(this IEnumerable<T> list) where T : ASMModelBase =>
            list.NonNull().Where(o => !o.isHidden && !o.IsTestAsset);
