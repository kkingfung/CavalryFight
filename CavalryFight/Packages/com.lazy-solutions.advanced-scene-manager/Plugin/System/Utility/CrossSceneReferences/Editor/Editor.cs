    ...
    static class Editor
    {
        ...
        static void ResolveScenes()
        {
            CoroutineUtility.Run(
                ...
                when: () => !EditorApplication.isCompiling && !BuildPipeline.isBuildingPlayer && SceneUtility.hasAnyScenes && SceneManager.profile,
                description: "Resolving cross-scene references");
        }
