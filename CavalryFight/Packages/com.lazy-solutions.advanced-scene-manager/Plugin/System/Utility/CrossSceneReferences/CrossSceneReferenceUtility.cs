...
#pragma warning restore CS0067
        ...
        static void Enable()
        {
            ...
            SceneManager.events.RegisterCallback<ScenePreloadPhaseEvent>(SceneOperation_ScenePreloadPhaseEvent, When.After);
        ...
        /// <summary>Gets the resolve status of <paramref name="scene"/>.</summary>
