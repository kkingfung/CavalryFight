...
namespace AdvancedSceneManager.Loading
{
    ...
    public abstract class LoadingScreenBase : MonoBehaviour, ILoadProgressListener
    {
        ...
        /// <summary>Called when ASM has opened scene.</summary>
        ...
        /// <summary>Called before ASM is closing scene.</summary>
        ...
        /// <summary>Called when progress changes for the associated scene operation.</summary>
