...
namespace AdvancedSceneManager.DependencyInjection.Editor
{
    ...
    public interface IBuildManager : DependencyInjectionUtility.IInjectable
    {
        ...
        /// <inheritdoc cref="BuildUtility.UpdateSceneList(bool, bool)"/>
        ...
        /// <inheritdoc cref="BuildUtility.DoBuild( string , bool  , bool  , bool  , BuildOptions)"/>
        ...
        /// <inheritdoc cref="BuildUtility.DoBuild(BuildPlayerOptions)"/>
