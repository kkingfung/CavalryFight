...
namespace AdvancedSceneManager.Models
{
    ...
    public static class ASMModelExtensions
    {
        ...
        public static int IndexOf<T>(this T collection, Scene scene) where T : ISceneCollection<Scene> =>
        ...
        public static void AddEmptyScene<T>(this T collection) where T : IEditableCollection
        {
            ...
            collection.Save();
            collection.OnPropertyChanged(nameof(ISceneCollection<Scene>.scenes));
        }
        ...
        /// <summary>Inserts a scene at the specified index in this collection.</summary>
