namespace AdvancedSceneManager.Models.Enums
{
    ...
    public enum CollectionStartupOption
    {
        ...
        /// <remarks>This means that if no collection in the list specifies either <see cref="Open"/> then the first collection in the list that has <see cref="Auto"/> will be opened.</remarks>
        Auto,
