...
namespace AdvancedSceneManager.Models
{
    ...
    public class InputBinding
    {
        ...
        /// <summary />
        public InputBinding(params InputButton[] buttons) =>
            m_buttons = buttons.ToList();

        [SerializeField] private List<InputButton> m_buttons;
        ...
        /// <summary>Gets if this input binding is valid, if it has any buttons.</summary>
        public bool isValid =>
            buttons.Any();

        /// <summary>Set the buttons for this input binding.</summary>
    ...
    public class InputButton
    {
        ...
        /// <summary>Gets if this input binding is valid.</summary>
