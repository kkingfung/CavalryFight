...
namespace AdvancedSceneManager.Core
{
    ...
    /// <summary>Defines flags that control the behavior of a <see cref="SceneOperation"/>.</summary>
    [Flags]
    public enum SceneOperationFlags
    {
        ...
        /// <summary>Includes loading screen scenes in the operation.</summary>
        LoadingScreen = 1 << 0,

        /// <summary>Invokes callbacks defined on the associated <see cref="SceneCollection"/>.</summary>
        CollectionCallbacks = 1 << 2,

        /// <summary>Invokes callbacks defined on the involved <see cref="Scene"/> objects.</summary>
        SceneCallbacks = 1 << 3,

        /// <summary>Triggers global event callbacks related to the operation.</summary>
        EventCallbacks = 1 << 4,

        /// <summary>Enables all available operation flags.</summary>
    ...
    partial class SceneOperation
    {
        ...
        /// <summary>Gets if this scene was opened from the default ASM scene collection.</summary>
        public bool isDefaultASMScene { get; private set; }

        /// <summary>Gets if this scene was opened from the standalone collection.</summary>
        public bool isStandaloneScene { get; private set; }
        ...
        /// <summary>Gets whatever <see cref="UnityEngine.Resources.UnloadUnusedAssets"/> should be called at the end (before loading screen).</summary>
        ...
        /// <remarks>This will disable scene loaders from reporting progress to <see cref="AdvancedSceneManager.Utility.LoadingScreenUtility.ReportProgress(ILoadProgressData)"/>. Loading screens and other listeners will not receive reports.</remarks>
