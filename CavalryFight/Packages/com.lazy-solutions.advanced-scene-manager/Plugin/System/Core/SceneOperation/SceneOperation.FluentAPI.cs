...
namespace AdvancedSceneManager.Core
{
    ...
    partial class SceneOperation
    {
        ...
        /// <summary>Specifies an associated collection.</summary>
        internal SceneOperation IsStandaloneScene() =>
            Set(() => isStandaloneScene = true);

        /// <summary>Specifies an associated collection.</summary>
        internal SceneOperation IsDefaultASMScene() =>
            Set(() => isDefaultASMScene = true);
        ...
        /// <remarks>Can be called multiple times to add more scenes to the operation.</remarks>
        /// <param name="scenes">The scenes to open.</param>
        /// <returns>The <see cref="SceneOperation"/> representing the operation.</returns>
        public SceneOperation Open(params Scene[] scenes) => Open(scenes.AsEnumerable());

        /// <summary>Specifies the scenes to prepend to the current open operation.</summary>
        /// <remarks>Scenes added this way will open before previously added ones.</remarks>
        /// <param name="scenes">The scenes to prepend.</param>
        /// <returns>The <see cref="SceneOperation"/> representing the operation.</returns>
        ...
        /// <inheritdoc cref="PrependOpen(Scene[])"/>
        ...
        /// <summary>Specifies whatever <see cref="UnityEngine.Resources.UnloadUnusedAssets"/> should be called at the end (before loading screen).</summary>
        ...
        /// <summary>Gets if this operation is frozen, as in, can its properties be changed?</summary>
        /// <remarks>Properties can only be changed before operation starts, which is exactly one frame after it has been invoked by the queue.</remarks>
