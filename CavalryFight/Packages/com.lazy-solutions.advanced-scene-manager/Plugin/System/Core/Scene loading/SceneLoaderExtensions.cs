...
namespace AdvancedSceneManager.Core
{
    ...
    public static class SceneLoaderExtensions
    {
        ...
        /// <inheritdoc cref="Load(Scene, bool, SceneOperation?, SceneCollection?, bool, ThreadPriority?, Action?, Action{string}?, bool)" />
        ...
        /// <inheritdoc cref="Unload(Scene, SceneOperation?, SceneCollection?, bool, ThreadPriority?, Action?, Action{string}?, bool)" />
        ...
        /// <param name="useOnlyGlobal">Specifies whatever only global scene loaders should be used.</param>
        /// <param name="loadPriority">Specifies the <see cref="ThreadPriority"/> to use for this operation.</param>
        public static IEnumerator Load(this Scene scene, bool isPreload = false, SceneOperation operation = null, SceneCollection collection = null, bool reportsProgress = true, ThreadPriority? loadPriority = null, Action onLoaded = null, Action<string> onError = null, bool useOnlyGlobal = false)
        {
            ...
            yield return RunSceneLoader(e, loadPriority, useOnlyGlobal);
            ...
            if (Validate(e, out var errorReason))
            {
                ...
                else if (operation?.isStandaloneScene ?? false)
                    scene.openedBy = SceneManager.profile.standaloneScenes;
                else if (operation?.isDefaultASMScene ?? false)
                    scene.openedBy = SceneManager.profile.defaultASMScenes;
        ...
        /// <param name="useOnlyGlobal">Specifies whatever only global scene loaders should be used.</param>
        /// <param name="loadPriority">Specifies the <see cref="ThreadPriority"/> to use for this operation.</param>
        public static IEnumerator Unload(this Scene scene, SceneOperation operation = null, SceneCollection collection = null, bool reportsProgress = true, ThreadPriority? loadPriority = null, Action onUnloaded = null, Action<string> onError = null, bool useOnlyGlobal = false)
        {
        ...
        internal static IEnumerator RunSceneLoader(SceneLoaderArgsBase e, ThreadPriority? loadPriority = null, bool useOnlyGlobal = false)
        {

            var loader = SceneManager.runtime.GetLoaderForScene(e.scene, useOnlyGlobal);
            if (loader is null)
                yield break;
        ...
        static bool Validate(SceneLoaderArgsBase e, [NotNullWhen(false)] out string errorReason)
        {
            ...
            if (e is SceneLoadArgs load && load.noSceneWasLoaded && !isValid)
