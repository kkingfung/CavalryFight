...
namespace AdvancedSceneManager.Editor.UI.Views.Popups
{
    ...
    class OverviewPopup : ViewModel, IPopup
    {
        ...
        public override VisualTreeAsset template => ((SceneManagerWindow)window).viewLocator.popups.overview;
        ...
        protected override void OnAdded()
        {
            ...
            RegisterEvent<OnWindowDisableEvent>(e =>
            {
        ...
        void Reload()
        {
            ...
            if (!isSearch)
            {
                ...
                importedFoldout.value = !unimportedScenes.Any();
                unimportedFoldout.value = unimportedScenes.Any();
                asmFoldout.value = false;
