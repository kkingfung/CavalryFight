...
namespace AdvancedSceneManager.Editor.UI.Views.Popups
{
    ...
    partial class SettingsPopup
    {
        ...
        public class EditorPage : SubPage
        {

            public override string title => "Editor";
            public override VisualTreeAsset template => ((SceneManagerWindow)window).viewLocator.popups.settings.editor.root;
            ...
            protected override void OnAdded()
            {
                ...
                view.Q("toggle-autoUpdateBuildScenes").BindToProfile();
                view.Q("toggle-active-build-profile-option").BindToProfile();
                view.Q("picker-build-profile").BindToProfile();
