...
namespace AdvancedSceneManager.Editor.UI.Views.Popups
{
    ...
    class MenuPopup : ViewModel, IPopup
    {
        ...
        public override VisualTreeAsset template => ((SceneManagerWindow)window).viewLocator.popups.menu;
        ...
        protected override void OnAdded()
        {
            ...
            if (context.customParam == flashDocsSection)
                FlashDocs();
        ...
        void SetupHeader()
        {
            ...
            view.Q<Button>("button-update").clicked += ASMWindow.OpenSettings<SettingsPopup.UpdatesPage>;
        }
        ...
        public static void DoDevBuild()
        {
            var path = GetBuildPath();
            BuildUtility.DoBuild(path + "/app.exe", attachProfiler: SceneManager.settings.user.quickBuildUseProfiler, true);
        }

        static string GetBuildPath() =>
              string.IsNullOrEmpty(SceneManager.settings.user.quickBuildPath)
              ? Path.Combine("Temp", "ASM quick build")
              : SceneManager.settings.user.quickBuildPath;
        ...
        void InitializeFolderButton()
        {
            ...
            folderButton.clicked += () =>
            {
                ...
                path = EditorUtility.OpenFolderPanel("Select folder to put builds in...", path, Application.productName);
        ...
        void InitializeDocs()
        {
            ...
            void HideNotification()
            {
                ...
                persistentNotificationService.ReloadNotifications();
