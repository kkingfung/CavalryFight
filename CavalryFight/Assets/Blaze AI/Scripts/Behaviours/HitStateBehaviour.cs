...
namespace BlazeAISpace
{
    ...
    {   
        ...
        [Min(0.1f), Tooltip("The duration in seconds to stay knocked out before getting up.")]
        ...
        [Tooltip("If enabled, on knock out the ragdoll will use the natural velocity of the rigidbody at that moment in time with no additional force.")]
        ...
        [Tooltip("If set to true will cancel the attack if got hit or knocked out.")]
        ...
        [Min(0), Tooltip("The radius to call other AIs when hit. You use this by calling blaze.Hit(player, true).")]
