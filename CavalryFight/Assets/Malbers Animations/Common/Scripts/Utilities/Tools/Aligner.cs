...
namespace MalbersAnimations.Utilities
{
    ...
    public class Aligner : MonoBehaviour, IAlign
    {
        ...
        public virtual void Align(Transform TargetToAlign)
        {
            if (Active && MainPoint && TargetToAlign != null)
            {
                ...
                if (AlignLookAt)
                {
                    C_Align_Rot = AlignLookAtTransform(TargetToAlign, MainPoint, AlignTime, AlignCurve);  //Align Look At the Zone
    ...
    public class AlignEditor : Editor
    {
        ...
        SerializedProperty
            AlignPos, AlignRot, AlignLookAt, AlingPoint1, AlingPoint2, AlignTime, ignoreY,
