...
namespace MalbersAnimations.Utilities
{
    ...
    public class AimTarget : MonoBehaviour, IAimTarget
    {
        ...
        {
            //CustomPatch: removed hacky "mute" try-catch => MAJOR NO-NO! Never EVER put runtime logic
            //wrapped in a "muted" try-catch statement that doesn't throw the error further => hidden logic issues which can generate hidden bugs VERY hard to track
            //try
            //{
