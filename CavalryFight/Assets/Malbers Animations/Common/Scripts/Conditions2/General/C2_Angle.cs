...
namespace MalbersAnimations.Conditions
{
    ...
    public class C2_Angle : ConditionCore
    {
        ...
        {
            var from = DirectionConverter(Target.Value ? Target.Value.transform : null, Direction);
            var to = DirectionConverter(Target2.Value ? Target2.Value.transform : null, Direction2);

            var axis = DirectionConverter(AxisTarget.Value ? AxisTarget.Value.transform : null, Direction2);
