...
namespace CavalryFight.Editor.MockData.MockServices
{
    ...
    public class MockMatchService : IMatchService
    {
        ...
        public PlayerScore[] GetAllPlayerScores()
        {
            return new[]
            {
                new PlayerScore { ClientId = 0, Score = 100, Kills = 5, Deaths = 2 },
                new PlayerScore { ClientId = 1, Score = 80, Kills = 3, Deaths = 4 },
                new PlayerScore { ClientId = 2, Score = 60, Kills = 2, Deaths = 5 },
                new PlayerScore { ClientId = 3, Score = 40, Kills = 1, Deaths = 6 }
            };
        }
